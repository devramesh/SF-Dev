...
declare module "@salesforce/schema/Opportunity.Credit_Card_No__c" {
  const Credit_Card_No__c:number;
  export default Credit_Card_No__c;
}
declare module "@salesforce/schema/Opportunity.CC_Exp_Date__c" {
  const CC_Exp_Date__c:any;
  export default CC_Exp_Date__c;
}
...
declare module "@salesforce/schema/Opportunity.commission__c" {
  const commission__c:number;
  export default commission__c;
}
declare module "@salesforce/schema/Opportunity.SolarBot_Model__c" {
  const SolarBot_Model__c:string;
  export default SolarBot_Model__c;
}
