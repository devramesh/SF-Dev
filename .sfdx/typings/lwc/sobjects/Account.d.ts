...
declare module "@salesforce/schema/Account.Account_Region__c" {
  const Account_Region__c:string;
  export default Account_Region__c;
}
declare module "@salesforce/schema/Account.AcctNamePhone__c" {
  const AcctNamePhone__c:string;
  export default AcctNamePhone__c;
}
declare module "@salesforce/schema/Account.Start_Date__c" {
  const Start_Date__c:any;
  export default Start_Date__c;
}
declare module "@salesforce/schema/Account.End_Date__c" {
  const End_Date__c:any;
  export default End_Date__c;
}
declare module "@salesforce/schema/Account.No_of_days__c" {
  const No_of_days__c:number;
  export default No_of_days__c;
}
declare module "@salesforce/schema/Account.Customer_ID__c" {
  const Customer_ID__c:string;
  export default Customer_ID__c;
}
declare module "@salesforce/schema/Account.Number_of_SolarBots__c" {
  const Number_of_SolarBots__c:number;
  export default Number_of_SolarBots__c;
}
declare module "@salesforce/schema/Account.Is_Phone_Active__c" {
  const Is_Phone_Active__c:string;
  export default Is_Phone_Active__c;
}
