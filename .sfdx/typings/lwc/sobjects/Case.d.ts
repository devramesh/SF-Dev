...
declare module "@salesforce/schema/Case.Days_Since_Last_Update__c" {
  const Days_Since_Last_Update__c:number;
  export default Days_Since_Last_Update__c;
}
declare module "@salesforce/schema/Case.Age_of_the_Case__c" {
  const Age_of_the_Case__c:number;
  export default Age_of_the_Case__c;
}
declare module "@salesforce/schema/Case.Case_Category__c" {
  const Case_Category__c:string;
  export default Case_Category__c;
}
