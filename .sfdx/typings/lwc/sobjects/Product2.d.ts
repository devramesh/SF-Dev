...
declare module "@salesforce/schema/Product2.Product_Image_Link__c" {
  const Product_Image_Link__c:string;
  export default Product_Image_Link__c;
}
declare module "@salesforce/schema/Product2.Product_Image__c" {
  const Product_Image__c:string;
  export default Product_Image__c;
}
declare module "@salesforce/schema/Product2.Rich_Text_Description__c" {
  const Rich_Text_Description__c:string;
  export default Rich_Text_Description__c;
}
