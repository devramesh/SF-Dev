...
declare module "@salesforce/schema/Lead.Sales_Zone__c" {
  const Sales_Zone__c:string;
  export default Sales_Zone__c;
}
declare module "@salesforce/schema/Lead.Product__r" {
  const Product__r:any;
  export default Product__r;
}
declare module "@salesforce/schema/Lead.Product__c" {
  const Product__c:any;
  export default Product__c;
}
declare module "@salesforce/schema/Lead.Account__r" {
...
declare module "@salesforce/schema/Lead.State_List__c" {
  const State_List__c:string;
  export default State_List__c;
}
